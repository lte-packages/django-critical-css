...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    def test_parse_sitemap_basic(self):
        ...
        from django_critical_css.management.commands.generate_critical_css import Command
    ...
    def test_should_process_url_new_url(self):
        ...
        should_process = command.should_process_url('https://new.example.com/', None, False)
    ...
    def test_should_process_url_lastmod_comparison(self):
        ...
        should_process = command.should_process_url('https://example.com/', new_date, False)
        self.assertTrue(should_process)
        
        # Older source should not be processed
        very_old_date = timezone.now() - timezone.timedelta(days=10)
        should_process = command.should_process_url('https://example.com/', very_old_date, False)
    ...
    def test_command_limit(self):
        ...
        try:
            out = StringIO()
            call_command('generate_critical_css', temp_sitemap, '--limit', '1', stdout=out)
